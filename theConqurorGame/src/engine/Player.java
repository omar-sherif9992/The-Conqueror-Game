...
//todo it was a void method
    public Unit recruitUnit(String type, String cityName) throws BuildingInCoolDownException, MaxRecruitedException, NotEnoughGoldException {
        ...
        if (correspondingMilitaryBuilding == null)
            return null;
        if(correspondingMilitaryBuilding.getRecruitmentCost() > this.getTreasury())
        ...
        this.setTreasury(this.getTreasury() - correspondingMilitaryBuilding.getRecruitmentCost());
    ...
    public void build(String type, String cityName) throws NotEnoughGoldException {
        ...
        if (doesExist == null) {
            ...
            if (building == null)
                return;
            if (building.getCost() > this.getTreasury())
